...
MAX_ELEV_LIMIT = 55
NUM_CANDIDATES = 20
MARS_CIRCUMFERENCE = 21344

# CONSTANTS: Derived:
IMG_HT, IMG_WIDTH = IMG_GRAY.shape
PIXELS_PER_KM = IMG_WIDTH / MARS_CIRCUMFERENCE
...
class Search():
    ...
    def draw_qc_rects(self):
        ...
        print("\nRect number of Corner Coordinates (ul_x, ul_y, lr_x, lr_y):")
    ...
    def make_final_display(self):
        """Using TK to show map of final rects & printout of their statistics."""
